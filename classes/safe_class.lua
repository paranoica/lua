local secure_class = function(create_function)
	...
	local metatable = {
		...
		__index = function(self, index)
			if source_cache[index] then
				...
				print("Error: this class has read-only access!")
				return nil
			end
		end,
...
--[[ @example:
	local new_class = secure_class(function()
		local structure do
			structure = {}
	...
	new_class.init_new_variable = true -> Error: this class has read-only access!
